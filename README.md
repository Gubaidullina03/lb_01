# lb_01. Реализация RPC-сервиса с использованием gRPC.
...
## 8 вариант. Финансовый сервис.

Описание сервиса и его методов: Сервис StockTicker: метод SubscribeToStockUpdates(stream TickerRequest) для подписки на котировки (Bidirectional streaming RPC).
